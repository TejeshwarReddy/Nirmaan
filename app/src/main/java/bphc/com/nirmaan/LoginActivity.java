        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Retrofit retrofit = new Retrofit.Builder()
                        ...
                        .build();
                BuildApi service =retrofit.create(BuildApi.class);

                if(in_up == 0) {
                    Call<SignIn> call = service.authenticateUser(username.getText().toString(), password.getText().toString());
                    ...
                    Call<SignUp> call = service.registerUser(username.getText().toString(), password.getText().toString(), usertype.getText().toString());
